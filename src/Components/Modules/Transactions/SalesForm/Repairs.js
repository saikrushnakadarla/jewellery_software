...
//   const { mobile } = location.state || {};
 ...
 const [searchValue, setSearchValue] = useState(selectedMobile || "");
  ...
  useEffect(() => {
    console.log("selectedMobile prop:", selectedMobile);
    console.log("mobile from location.state:", mobile);
    console.log("searchValue being used:", selectedMobile || mobile || "");

    if (selectedMobile) {
      setSearchValue(selectedMobile);
    }
