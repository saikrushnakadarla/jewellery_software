            ...
            <Row>
                ...
                <>
                  ...
                  <Col xs={12} md={2}>
                    <InputField
                      label="Balance Wt"
                      type="number"
                      value={(parseFloat(formData.paid_pure_weight) > 0 || parseFloat(formData.paid_amount) > 0)
                        ? formData.balance_pure_weight
                        : ""}
              ...
              <Col xs={12} md={2}>
                <InputField
                  label="Balance Amt"
                  type="number"
                  value={(parseFloat(formData.paid_amount) > 0 || parseFloat(formData.paid_pure_weight) > 0)
